...
public class Log implements AutoCloseable {
    ...
    private static final Level TRACE_LEVEL = Level.TRACE;
    ...
    public void close() {
        --traceLogIndex;
        LOGGER.log(TRACE_LEVEL, MARKER_TRACE, "{}> Leaving {}", PADDING_STACK.get(traceLogIndex), methodName);
    }
